...
router.post(
  ...
  async (req, res) => {
    ...
    // map through the skills array and then take out the spaces
    if (skills) {
...
// @todo:
// Make sure that the req.params.edu_iod / exp_id is working. that it is not deleting the first index if there's no match
